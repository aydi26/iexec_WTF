...
- **Live + Sourcify-verified deployments (current — bidirectional, third-party sends enabled):** cUSDC ETH `0x47d150572dFCEB75C27b6dDf5EADc4D6fa33e41C` · Arb `0xD74A1F2bF0285Dc64F7855D0233E774772Ab0209`. **ETH→Arb**: Batcher@ETH `0x82688B8890Aab5744135cB26C3292eb821A4934A`, Distributor@Arb `0x1a87F73D57BeF323376860a7B3f11f7C18AcE666`. **Arb→ETH**: Batcher@Arb `0x0c0695023920e4e8F89976773998fC77E7b2f000`, Distributor@ETH `0x3B9d67AD5B02a50d8B0db0890FCF2060BdcC80eC`. All 6 Sourcify `exact_match`. (Earlier redeploy sets appear only in past worklog entries.)
