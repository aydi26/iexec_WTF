...
- [x] Wrappers  · [x] Batcher  · [x] Settlement+CCTP  (live burn→Iris→relayReceive both directions) · [x] Distributor  · [x] Integrity+fallback  · [x] Frontend  (base UI shell + 5 Noxus views, builds) · [x] Auditor  (grantAuditor; add-only) · [x] **E2E no-mock: DoD ① AND ② both LIVE** · [x] Contracts verified (Sourcify exact_match ×4) · [ ] Video+X post
- **Live + Sourcify-verified deployments (hardened set, current):** ETH Sep — cUSDC `0x47d150572dFCEB75C27b6dDf5EADc4D6fa33e41C`, Batcher `0x814a70961395218365DA5892F5de768a9Ed84E37` · Arb Sep — cUSDC `0xD74A1F2bF0285Dc64F7855D0233E774772Ab0209`, Distributor `0x410195cF6137661B066d4264515C6dc9b860ECFA`. (Earlier redeploy sets appear only in past worklog entries.)
