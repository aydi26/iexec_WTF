...
| D-006 | *pending* — hookData inline vs Distributor pre-registration | — | decide from Day-0 size + proof-binding tests (S3: leaning inline — 137-B proofs ⇒ N=10 ≈ 3.3 KB ≪ 7964 B budget) | — |
