...
/// @title NoxusCUSDC — deployable confidential-USDC wrapper for Noxus.
...
contract NoxusCUSDC is ERC20ToERC7984Wrapper {
    constructor(IERC20 usdc)
        ERC20ToERC7984Wrapper("Noxus Confidential USDC", "cUSDC", "", usdc)
    {}
}
